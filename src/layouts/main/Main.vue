...
<template>
  ...
  >
    ...
    <v-nav-menu :navMenuItems="navMenuItems" title="Tiny Url" parent=".layout--main" />
...
burayaefe
      ...
      -->
      <div class="content-wrapper vs-con-loading__container" id="contentLoader">
...
export default {
  ...
  created() {
    this.navMenuItems = this.$store.state.AppActiveUser.navMenuItems;
